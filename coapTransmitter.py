...
log.setLevel(logging.DEBUG)#ERROR
    ...
    def transmit(self):
        ...
        with self.dataLock:
            ...
            if self.coapError:
                ...
                #Next line is Added by mm, while last one was as commented
                self.coapResponse = {'payload': []}
                return self.coapResponse #raise self.coapError 
